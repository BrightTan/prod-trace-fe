    ...
    <div class="process-index">
      ...
      <el-row :gutter="30" class="cards">
        ...
        <el-col :xl="8" :lg="8" :md="8" :sm="24"
          ><RotateBlock
            title="加工中产品总数"
            :number="indexData.processingNum"
        ...
        <el-col :xl="8" :lg="8" :md="8" :sm="24"
          ><RotateBlock
            title="生产线总数"
            :number="indexData.productLineNum"
          ...
          <div class="right">
            ...
            <div class="tian-container" style="height:500px">
              <ScrollBar color="rgba(255,255,255,0.5)">
                <div
                  v-for="item in indexData.processingLine"
                  :key="item.productLineNumber"
                  class="tian"
                >
...
export default {
  ...
  data() {
    return {
      indexData: {
        processedNum: 0, //已加工的产品总数
        processingNum: 0, //加工中的产品总数
        productLineNum: 0, //生产线总数
        announcement: "", //公告
