          ...
          this.config = {
            ...
            items: [
              ...
              },
              {
                ...
                label: "企业许可编号",
                variable: "compTel",
                default: res.data.permitNo,
              },
              {
                type: "computed",
                label: "生产线数量",
                variable: "productionLineNumber",
                computed: (formData) => {
                ...
                dialogConfig: {
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      option: {
                        placeholder: "请输入生产线负责人",
                      },
                    },
                  ],
                  default: () => res.data.productLineInfo,
                },
              },
              {
                type: "block",
                ...
                dialogConfig: {
                  ...
                  default: () => [
                    {
                      compTransId: res.data.compTransId,
                      compTransName: res.data.compTransName,
                    },
                  ],
      ...
      this.$Http
        .post({
          ...
          data: {
            ...
            compTransInfo: formData.compTransInfo,
