    ...
    <div class="product-index">
      ...
      <el-row :gutter="30" class="cards">
        <el-col :xl="6" :lg="6" :md="12" :sm="24"
          ><RotateBlock
            title="已完工的产品总数"
            :number="indexData.completedProductionNum"
        ...
        <el-col :xl="6" :lg="6" :md="12" :sm="24"
          ><RotateBlock
            title="生产中产品总数"
            :number="indexData.inProductionNum"
        ...
        <el-col :xl="6" :lg="6" :md="12" :sm="24"
          ><RotateBlock
            title="种子类别数"
            :number="indexData.seedCategories"
        ...
        <el-col :xl="6" :lg="6" :md="12" :sm="24"
          ><RotateBlock
            title="田块总数"
            :number="indexData.fieldNum"
            :customStyle="{ 'background-color': '#3f4e62' }"
          ></RotateBlock>
        </el-col>
      </el-row>
          ...
          <div class="right">
            ...
            <div class="tian-container" style="height:500px">
              <ScrollBar color="rgba(255,255,255,0.5)">
                <div
                  v-for="item in indexData.fieldInProduction"
                  :key="item.fieldNumber"
                  class="tian"
                >
                  <span>{{ item.fieldNumber }}</span>
                  <span>{{ item.seedCategory }}</span>
                </div>
              </ScrollBar>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      indexData: {
        completedProductionNum: 0, //已完工产品总数
        inProductionNum: 0, //生产中产品总数
        seedCategories: 0, //种子类别
        fieldNum: 0, //田块总数
        announcement: "", //公告
