<template>
  <el-container class="sale-layout">
        ...
        <div>
          ...
          >
            ...
            <el-submenu index="1" popper-class="layout-menu-popper">
              ...
              <el-menu-item index="/sale/productSaleInfo">
                <i class="el-icon-document"></i>
                <span slot="title">产品销售信息</span></el-menu-item
              >
              <el-menu-item index="/sale/finishSale">
                <i class="el-icon-document"></i>
                <span slot="title">完成产品销售</span></el-menu-item
              >
              <el-menu-item index="/sale/buildQRCode">
                <i class="el-icon-document"></i>
                <span slot="title">生成最终溯源码</span></el-menu-item
              >
            </el-submenu>
            <el-submenu index="2" popper-class="layout-menu-popper">
              ...
              <el-menu-item index="/sale/personalProfile">
                <i class="el-icon-document"></i>
                <span slot="title">个人信息管理</span></el-menu-item
              >
              <el-menu-item index="/sale/manageComInfo">
                <i class="el-icon-document"></i>
