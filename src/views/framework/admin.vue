          ...
          >
            ...
            <el-submenu index="1" popper-class="layout-menu-popper">
              ...
              <el-menu-item index="/admin/announce">
                <i class="el-icon-document"></i>
                <span slot="title">公告管理</span></el-menu-item
              >
              <el-menu-item index="/admin/ajugeComInfo">
                <i class="el-icon-document"></i>
                <span slot="title">企业信息更改审核</span></el-menu-item
              >
              <el-menu-item index="/admin/comManage">
                <i class="el-icon-document"></i>
                <span slot="title">企业管理</span></el-menu-item
              >
              <el-menu-item index="/admin/productInfo">
                <i class="el-icon-document"></i>
                <span slot="title">销售产品信息</span></el-menu-item
              >
            </el-submenu>
            <el-submenu index="2" popper-class="layout-menu-popper">
              <template slot="title">
                <i class="el-icon-document"></i>
                <span slot="title">消费者反馈</span>
              </template>
              <el-menu-item index="/admin/comReport">
                <i class="el-icon-document"></i>
                <span slot="title">企业举报信息处理</span></el-menu-item
              >
            </el-submenu>
            <el-submenu index="3" popper-class="layout-menu-popper">
              <template slot="title">
                <i class="el-icon-document"></i>
                <span slot="title">用户信息管理</span>
              </template>
              <el-menu-item index="/admin/personalProfile">
                <i class="el-icon-document"></i>
