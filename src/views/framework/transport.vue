<template>
  <el-container class="transport-layout">
    <el-aside :class="{ collapse: collapseMenu }">
      <ScrollBar :size="4" color="rgba(0,0,0,0.2)">
        <div>
          ...
          >
            <el-menu-item index="/transport/index"
            ...
            <el-submenu index="1" popper-class="layout-menu-popper">
              <template slot="title">
                <i class="el-icon-document"></i>
                <span slot="title">运输信息管理</span>
              </template>
              <el-menu-item index="/transport/transportProductInfo">
                <i class="el-icon-document"></i>
                <span slot="title">产品运输信息</span></el-menu-item
              >
              <el-menu-item index="/transport/finishTransport">
                <i class="el-icon-document"></i>
                <span slot="title">完成运输工作</span></el-menu-item
              >
              <el-menu-item index="/transport/finishedProductInfo">
                <i class="el-icon-document"></i>
            ...
            <el-submenu index="2" popper-class="layout-menu-popper">
              ...
              <el-menu-item index="/transport/personalProfile">
                <i class="el-icon-document"></i>
                <span slot="title">个人信息管理</span></el-menu-item
              >
              <el-menu-item index="/transport/manageComInfo">
                <i class="el-icon-document"></i>
